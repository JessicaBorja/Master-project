...
from vapo.affordance_model.utils.losses import \
    compute_mIoU, compute_dice_score, \
    compute_dice_loss, get_affordance_loss, CosineSimilarityLossWithMask
...
class Segmentator(pl.LightningModule):
    def __init__(self, cfg, cmd_log=None):
        ...
        # Loss function
        self.affordance_loss = get_affordance_loss(cfg.aff_loss, cfg.n_classes)
        self.center_loss = CosineSimilarityLossWithMask(weighted=True)
        self.loss_cfg = {"affordance": cfg.aff_loss,
                         "centers": cfg.centers_loss}
    ...
    def init_model(self, decoder_channels=None, n_classes=2):
        ...
        center_direction_net = nn.Conv2d(feature_dim, 2,
    ...
    def _calc_aff_loss(self, preds, labels):
        ...
        if cfg.dice_loss.add:
            ...
            loss = cfg.ce_loss.weight * ce_loss + \
                cfg.dice_loss.weight * dice_loss
    ...
    def compute_loss(self, preds, labels):
        ...
        # Affordance loss
        aff_loss, info = self._calc_aff_loss(preds["affordance_logits"],
                                             labels["affordance"])
